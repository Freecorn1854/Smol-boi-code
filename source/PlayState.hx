...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['you mad uh? you prob dead by now. snowboi can kick your 9 year old ass at this song!', 0.2], //From 0% to 19%
		['a liilte better, prob 10 tho', 0.4], //From 20% to 39%
		['uh its fine but still bad', 0.5], //From 40% to 49%
		['50% porb about to die tho', 0.6], //From 50% to 59%
		['"meh" - snowboi', 0.69], //From 60% to 68%
		['i am mc lovein it (can we even use that?)', 0.7], //69%
		['ok you are meh at the game, 7/10', 0.8], //From 70% to 79%
		['nice, prob 13+', 0.9], //From 80% to 89%
		['sick, miss one note tho', 1], //From 90% to 99%
		['you are ItsWolfiii, nice that YOU are playing this mod, if you not them this is not for you!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'winterhappy': //edited week 1 code cuz im lazy
				var bg:BGSprite = new BGSprite('background', -600, -200, 0.9, 0.9);
				add(bg);

			//	var stageFront:BGSprite = new BGSprite('fgSnow', -650, 600, 0.9, 0.9);
